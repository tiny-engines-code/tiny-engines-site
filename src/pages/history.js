        ...
        <ContentLayout>
            ...
            <ContentWrapper>
              ...
              <div>
                ...
                <a href={`Chris.Lomeli.2022.CV.pdf`} download>Download CV</a>
<hr/>
                ...
                <div className="cvflip">
                    <div className="cvfront"
                         style={{backgroundImage: `url(Chris.Lomeli.2022.CV1.png?w=1260&h=750&dpr=2&auto=compress&cs=tinysrgb)`}}>
                    </div>
                    <div className="cvback" style={{backgroundImage: `url(Chris.Lomeli.2022.CV2.png?w=1260&h=750&dpr=2&auto=compress&cs=tinysrgb)`}}>
                    </div>
                </div>
    </div>
