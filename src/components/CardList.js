...
class CardList extends React.Component {
    ...
    state = {
        cards: [
            ...
            {title: "work", topic: "mailboy.png",  linkTo: "/history" , backColor: "#1d1e21", backTitle:"four legs good, two legs ...better", backText: "boilerplate recital mixed with occasional rebellion"},
